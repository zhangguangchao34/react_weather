(function e(t, n, r) {
    ...
    }, { "./lib/vectortile.js": 5, "./lib/vectortilefeature.js": 6, "./lib/vectortilelayer.js": 7 }],
    ...
    }, { "./MVTUtil": 11, "./StaticLabel/StaticLabel.js": 12 }],
            ...
            _onClick: function (evt) {
                ...
                if (clickableLayers && clickableLayers.length > 0) {
                    ...
                    for (var i = 0, len = clickableLayers.length; i < len; i++) {
                        ...
                        var layer = layers[key];
                        if (layer) {
                            layer.handleClickEvent(evt, function (evtItem) {
                                if (typeof onClick === 'function') {
                                    // onClick(evt);
                                    if (evtItem.feature && evtItem.latlng) {
                                        latlng = evtItem.latlng;
                                        // console.log(evtItem.feature.layer.name)
                                        evtArr.push(evtItem.feature);
                                    }
                                }
                            });
                        }
                    }
                    // console.log(evtArr[0].feature.layer.name + '     ' + evtArr[1].feature.layer.name)
                    onClick(evtArr, latlng);
                } else {
                    if (typeof onClick === 'function') {
                        onClick(evt);
                    }
    ...
    }, { "./MVTLayer": 9, "./MVTUtil": 11, "pbf": 1, "point-geometry": 3, "vector-tile": 4 }],
    ...
    }, { "base64-js": 15, "ieee754": 16, "is-array": 17 }],
